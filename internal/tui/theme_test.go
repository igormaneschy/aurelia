...
func TestNewDarkStylesPopulatesAllFields(t *testing.T) {
	...
	checkRenderable("InputPendingStyle", s.InputPendingStyle)
	checkRenderable("Surface1Style", s.Surface1Style)
	checkRenderable("ChipStyle", s.ChipStyle)
	checkRenderable("SidebarSectionStyle", s.SidebarSectionStyle)
	checkRenderable("SidebarHoverStyle", s.SidebarHoverStyle)
	checkRenderable("SidebarButtonStyle", s.SidebarButtonStyle)
	...
	checkRenderable("AlertChipStyle", s.AlertChipStyle)
	checkRenderable("ComposerSpacerStyle", s.ComposerSpacerStyle)
